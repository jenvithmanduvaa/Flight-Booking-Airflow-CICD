...
with DAG(
    ...
    gcs_bucket = Variable.get("gcs_bucket", default_var="airflow-projetcs-gds2")
    bq_project = Variable.get("bq_project", default_var="buoyant-ceiling-450722-c0")
    ...
    batch_details = {
        ...
        "environment_config": {
            "execution_config": {
                "service_account": "960789838597-compute@developer.gserviceaccount.com",
                "network_uri": "projects/buoyant-ceiling-450722-c0/global/networks/default",
                "subnetwork_uri": "projects/buoyant-ceiling-450722-c0/regions/us-central1/subnetworks/default",
            }
        },
    }
    ...
    pyspark_task = DataprocCreateBatchOperator(
        ...
        batch=batch_details,
        batch_id=batch_id,
        project_id="buoyant-ceiling-450722-c0",
        region="us-central1",
